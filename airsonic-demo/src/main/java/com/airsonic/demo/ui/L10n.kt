...
private val ZH = Strings(
    ...
    soundOnlyDesc = "捕获系统音频实时投到所选音箱（AirPlay/Sonos）；投画面请用上方系统投屏",
    startMirror = "开始投声音",
...
private val EN = Strings(
    ...
    soundOnlyDesc = "Capture system audio live to the chosen speaker (AirPlay/Sonos); for screen use system cast above",
