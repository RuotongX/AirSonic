...
data class Strings(
    ...
    val castDevice: String,         // 投屏设备（未识别时的通用名）/ Cast device
...
private val ZH = Strings(
    ...
    soundOnlyDesc = "实时把系统声音投到所选设备（AirPlay/DLNA）",
    soundInfo = "捕获系统音频，实时投到所选设备（AirPlay/DLNA）。只投声音、不含画面；要投画面请用上方「投画面」的应用内投屏。",
    ...
    version = "AirSonic · 版本",
    licenseLine = "© 2026 Chunguang Wei（上游）· 魔改 by Ruotong Xu\nPolyForm Noncommercial 1.0.0 · 仅限非商业使用，商业使用需作者书面授权\n联系 / Bug 反馈：chunguangwee@gmail.com",
    ...
    dlnaDevice = "DLNA 设备", castDevice = "投屏设备",
    ...
    forceAlacSub = "一般别开!普通音箱强制 ALAC 会无声;只收 ALAC 的设备已自动探测",
    codecLabel = "编码",
    ...
    mirrorInAppSub = "录屏+系统声音实时投到选中的设备（电视/投影/盒子/Apple TV/Mac），延迟约 1~3 秒",
...
private val EN = Strings(
    ...
    soundOnlyDesc = "Live-cast system audio to the selected device (AirPlay/DLNA)",
    soundInfo = "Captures system audio and casts it live to the selected device (AirPlay/DLNA). Sound only, no screen — for screen use the in-app \"Mirror screen\" above.",
    ...
    licenseLine = "© 2026 Chunguang Wei (upstream) · fork mod by Ruotong Xu\nPolyForm Noncommercial 1.0.0 · Noncommercial use only; commercial use requires written consent\nContact / bug reports: chunguangwee@gmail.com",
    language = "Language",
    ...
    dlnaDevice = "DLNA device", castDevice = "Cast device",
    protocolsTitle = "Protocols", protocolsSub = "AirPlay · DLNA · Screen mirroring", tagSystem = "System",
    ...
    forceAlacSub = "Usually keep OFF! Forcing ALAC silences PCM-only speakers; ALAC-only devices are auto-detected",
    codecLabel = "Codec",
    ...
    mirrorInAppSub = "Mirror screen + system sound live to the selected device (TV/projector/box/Apple TV/Mac), ~1–3s delay",
